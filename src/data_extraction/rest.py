...
# HELPER FUNCTIONS
# ----------------
def reauthorize(directory='.', key_id=0):
    # Get an authentication object with key_id from our authentication module

    auth = twitter_auth.authorize(key_id=key_id, directory=directory)
